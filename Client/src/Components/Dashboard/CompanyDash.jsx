      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-4xl font-bold text-gray-900 mb-1">{stats.totalApplications}</p>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <p className="text-4xl font-bold text-gray-900 mb-1">{stats.thisMonth}</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-gray-600 text-base">
              No recent activity. Applications will appear here once candidates start applying.
            </p>
          </div>
        </div>
      </div>
